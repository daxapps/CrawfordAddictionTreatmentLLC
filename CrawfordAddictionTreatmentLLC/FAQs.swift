...
extension FAQs {
    ...
    static func localQnAData() -> [[String: String]] {
        return [
            ...
            [FAQs.QuestionKey : "How much do the visits cost?", FAQs.AnswerKey : "The patient has a choice of coming in every 1, 2, or 4 weeks.  It will cost $100 for 1 week, $190 for 2 weeks, or $300 for 4 weeks.  Drug screens are included in the cost of the visit."],
